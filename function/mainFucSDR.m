function tIter = mainFucSDR(Nt, nIRSrow, nIRScol, Ns, K, R, Pt, P2, P, Lambda, sigma, alphaMax, alpha, epsilon, thetaVecCurrent, G_NLoS, g_NLoS, h_NLoS, JamPosErr)
    ...
    G = G / sigma;
    g = g / sigma;
    % thetaMatCurrent = thetaMatCurrent  / (0.2 * alphaMax);
    ...
    while realChange >= epsilon && iIter < 10
        ...
        while IterD < 20
            IterD = IterD + 1;
            [W, thetaMat] = updateBeamSDR(Nt, K, Ns, R, thetaMatCurrent, wCurrent, dCurrent, tCurrent, muCurrent, G, g, h, Pt, P2, P, alphaMax);
